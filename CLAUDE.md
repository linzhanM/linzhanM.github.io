...
- `buttons.js` from `buttons.github.io` is still loaded in `index.html` but **nothing uses it** — there is no `github-button` element anywhere. It is a dead fetch, safe to delete.
